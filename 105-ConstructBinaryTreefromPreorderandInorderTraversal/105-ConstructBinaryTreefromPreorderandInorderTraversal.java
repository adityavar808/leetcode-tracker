// Last updated: 8/13/2025, 10:52:12 AM
/**
...
class Solution {
    public void function(int[] preorder, HashMap<Integer, Integer> map, int si, int ei,  int[] start,  TreeNode node)
    {
        ...
        if(ei>=mid+1) {
            ...
            node.right=node3;
            function(preorder, map, mid+1, ei, start, node3); // taking a section of inorder arr[] i.e from mid+1 to si 
        }
    }
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        int start[]={0};
        int si=0; // si == start of inorder
        int ei=inorder.length-1; // ei== end of inorder 
